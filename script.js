    ...
    if (!document.getElementById('live-stream-widget')) {
        ...
        streamContainer.innerHTML = `
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                ...
                <a href="https://www.twitch.tv/dota2ti" target="_blank" style="background: #9146FF; color: #fff; padding: 6px 14px; border-radius: 4px; text-decoration: none; font-size: 0.85rem; font-weight: bold;">Открыть на Twitch ↗</a>
            </div>
